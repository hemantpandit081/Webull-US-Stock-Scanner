...
.scanner-header {
    display: grid;
    grid-template-columns: 1.5fr 1fr 0.9fr 0.9fr 1.2fr;
    align-items: center;
    padding: 6px 4px;
    margin-top: 2px;
    margin-bottom: 4px;
...
# Number of simultaneous Webull requests
MAX_WORKERS = 10
...
def parse_snapshot(
    ...
    try:
        ...
        # -------------------------------------------------
        # Convert change ratio to percentage
        # -------------------------------------------------
...
def scan_stocks():
    ...
    # Copy previous volumes before scanning
    previous_volumes = (
        st.session_state
        .previous_volumes
        .copy()
    ...
    # -----------------------------------------------------
    # 10 Webull requests at the same time
    # -----------------------------------------------------
